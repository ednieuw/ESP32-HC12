...
The FM-module can be used to read the RDS-time from radio station or to play FM-radio station from within the clock
 ...
 Changes : V117 PA02 Added HC12 voor Paul Andries
 Changes : V117 PA03 Menu option L, M, N and O can also be sent to with ESP32ArduinoCommV031
 */
// ===============================================================================================================================
char VERSION[] = "Character_Clock_V117PA03";
//--------------------------------------------
...
//#define ROTARYMOD                 // Use a rotary encode
                    ...
                    // HC12 or Bluetooth; same pins 6 and 7
#define HC12MOD                    // Use HC12 time transreceiver Long Range Wireless Communication Module in Bluetooth slot (pin 6 and 7)
...
// HC12String += "\n";
 if (HC12String.length()>0 && HC12String.length()<8)  // T123456 totals 7 
   {
